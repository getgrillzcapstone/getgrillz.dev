{{-- <nav class="navbar navbar-default customNavbar">
  <div class="container-fluid customNavbar">
    ...
    <div class="navbar-header">
      ...
      <a class="" href="#"><img src="/getgrillz_images/logo.png" class="navbarLogo"></a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="navbarName"><a href="#" class="navbarName">GetGrillz</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li class="navbarFAQ"><a href="#">FAQ</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav> --}}
