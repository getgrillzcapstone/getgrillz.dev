    ...
    <div class="container-fluid">
        <div class="row footerContainer">
            <span class="col-xs-3 col-sm-3 col-md-3 col-lg-3 iconSpan">
                <a href="https://twitter.com/WeberGrills" target="_blank" class="btn btn-social">
                    <img src="/getgrillz_images/twitterIcon.png"><h4 class="footerLinks">Twitter</h4>
                </a>
            </span>
            <span class="col-xs-3 col-sm-3 col-md-3 col-lg-3 iconSpan">
                <a href="https://www.facebook.com/NapoleonGrilling/" target="_blank" class="btn btn-social">
                    <img src="/getgrillz_images/facebookIcon.png"><h4 class="footerLinks">Facebook</h4>
                </a>
            </span>
            <span class="col-xs-3 col-sm-3 col-md-3 col-lg-3 iconSpan">
